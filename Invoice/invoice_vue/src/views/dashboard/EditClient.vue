    ...
    <div class="page-add-client">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li><router-link :to="{ name: 'Client', param: { id: client.id }}">{{ client.name }}</router-link></li>
                <li class="is-active"><router-link :to="{ name: 'EditClient', param: { id: client.id }}" aria-current="true">Edit</router-link></li>
            </ul>
        </nav>
