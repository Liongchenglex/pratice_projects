    ...
    <div class="page-add-invoice">
        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <div class="select">
                    <!-- whatever selected will be synced with invoice.client in data() -->
            ...
            <div class="column is-12">
                ...
                <!-- v-on to sync the form's gross amount to total amount in the AddInvoice page -->
                <!-- v-on will listen to the event updatePrice emitted by the Component -->
                <ItemForm
...
export default {
    ...
    methods: {
        ...
        // argument gets passed in from Component
        updateTotals(changedItem) {
            ...
            this.invoice.vat_amount = vat_amount.toFixed(2)
            this.invoice.gross_amount = (net_amount + vat_amount).toFixed(2)
        ...
        submitForm() {
            ...
            axios
                ...
                .catch(error => {
                    this.errors =[]
                    this.errors.push('Please fill in all necessary fields')
                    console.log(JSON.stringify(error))
                })
        }
    }
