    ...
    <div class="page-invoice">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><router-link :to="{ name: 'Invoice', param: { id: invoice.id }}" aria-current="true">{{ invoice.invoice_number }}</router-link></li>
            </ul>
        </nav>
    ...
    methods: {
        ...
        getStatusLabel() {
                if (this.invoice.is_paid) {
                    return 'Is paid'
                } else if (this.invoice.is_credited) {
                    return 'Is credited'
                } else {
                    return 'Sent but not paid'
                }
            },
        getInvoiceType() {
        ...
        async setAsPaid() {
            ...
            // items are deleted because it is read only
