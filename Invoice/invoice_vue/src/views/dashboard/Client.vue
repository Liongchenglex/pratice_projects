    ...
    <div class="page-clients">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><router-link :to="{ name: 'Client', param: { id: client.id }}" aria-current="true">{{ client.name }}</router-link></li>
            </ul>
        </nav>
        <div class="columns is-multiline">
            <div class="column is-12">
                ...
                <!-- strange note why is it 'param' and not 'params' ??-->
                <router-link :to="{ name: 'EditClient', param: { id : client.id}}" class="button is-light mt-4">Edit</router-link>
            </div>
